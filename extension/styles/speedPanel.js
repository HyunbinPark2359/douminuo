...
(function (g) {
  ...
  g.nuoSpeedPanelCss = [
    ...
    '}',
    /* 펼치기 버튼 + 구분선 (심플 패널) */
    '.expand-sep { height: 1px; background: #d9d9d9; margin: 12px 0 8px; }',
    '.expand-btn {',
    ...
    '  letter-spacing: -0.3px; padding: 2px 0; text-align: center;',
    '  transition: color .2s cubic-bezier(.25,.8,.5,1);',
    '}',
    '.expand-btn:hover { color: #e4007f; }',
    /* 대형 전체표 패널 (별도 Shadow DOM host) */
    '.table-panel {',
    '  box-sizing: border-box; width: 362px; height: 780px; background: #fff;',
    '  border: 1px solid #ddd; border-radius: 12px;',
    '  box-shadow: 0 8px 24px rgba(15, 23, 42, 0.12);',
    '  padding: 16px 16px 14px; display: flex; flex-direction: column; overflow: hidden;',
    '}',
    '.table-title {',
    '  font-family: SCDream, sans-serif; font-size: 14px; font-weight: 500;',
    '  color: #272727; letter-spacing: normal;',
    '  text-align: center; margin: 0 0 9px; padding: 0; flex: 0 0 auto;',
    '}',
    '.table-body { flex: 1 1 auto; overflow-y: auto; font-size: 11px; color: #0f172a; letter-spacing: -0.25px; }',
    '.table-note { font-size: 10px; color: #94a3b8; margin-bottom: 8px; }',
    '.table-body .species-pop-divider-label { font-size: 10px; }',
    /* 대형 표 스크롤바 — 얇게 + 트랙 투명 + 스크롤 중에만 표시(오토하이드) */
    '.table-body::-webkit-scrollbar { width: 6px; }',
    '.table-body::-webkit-scrollbar-track { background: transparent; }',
    '.table-body::-webkit-scrollbar-thumb {',
    '  background: rgba(148, 163, 184, 0); border-radius: 3px;',
    '  transition: background .5s ease;',
    '}',
    '.table-body.scrolling::-webkit-scrollbar-thumb { background: rgba(148, 163, 184, 0.5); }',
    '.table-body.scrolling::-webkit-scrollbar-thumb:hover { background: rgba(148, 163, 184, 0.78); }',
  ].join('\n');
