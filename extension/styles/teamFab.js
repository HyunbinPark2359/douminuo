...
(function (g) {
  ...
  g.nuoTeamFabCss = [
    ...
    '}',
    '.fab-btn {',
    '  position: relative; isolation: isolate; border: none; cursor: pointer; display: inline-flex; align-items: center;',
    '  justify-content: center; flex-shrink: 0; border-radius: 50%; color: #0f172a;',
    '}',
    '/* F46: 정적 box-shadow 두 상태를 ::before/::after 에 깔고 opacity 만 보간 */',
    '.fab-btn:not(:disabled):not(.fab-slot--empty)::before,',
    '.fab-btn:not(:disabled):not(.fab-slot--empty)::after {',
    '  content: ""; position: absolute; inset: 0; border-radius: inherit; z-index: -1; pointer-events: none;',
    '}',
    '.fab-btn:not(:disabled):not(.fab-slot--empty)::before {',
    '  box-shadow: 0 4px 14px rgba(156, 207, 229, 0.32), 0 0 0 1px rgba(156, 207, 229, 0.35);',
    '  animation: nuo-tb-glow-xfade-a 3.4s ease-in-out -0.6s infinite;',
    '}',
    '.fab-btn:not(:disabled):not(.fab-slot--empty)::after {',
    '  box-shadow: 0 6px 18px rgba(120, 185, 210, 0.34), 0 0 0 1px rgba(156, 207, 229, 0.48);',
    '  animation: nuo-tb-glow-xfade-b 3.4s ease-in-out -0.6s infinite;',
    '}',
    ...
    '}',
    '/* 슬롯 빈/안빈·파티 동일: glow pseudo opacity xfade + fab-click-bounce. 빈슬롯은 ::before/::after 없음 */',
    '.fab-btn.fab-copy-click-pulse:not(:disabled):not(.fab-copy-error) {',
    '  animation: fab-click-bounce 0.1s cubic-bezier(0.22, 1, 0.36, 1) !important;',
    '}',
    ...
    '}',
    '.fab-settings-morph {',
    '  position: relative; isolation: isolate; width: 52px; min-height: 52px; max-height: 52px; border-radius: 26px;',
    '  overflow: hidden;',
    '  background: linear-gradient(155deg, #f7fcfe 0%, #c5e8f4 40%, #9ccfe5 100%);',
    '  color: #2a6f8f;',
    '  cursor: pointer;',
    ...
    '}',
    '.fab-settings-morph::before, .fab-settings-morph::after {',
    '  content: ""; position: absolute; inset: 0; border-radius: inherit; z-index: -1; pointer-events: none;',
    '}',
    '.fab-settings-morph::before {',
    '  box-shadow: 0 4px 14px rgba(156, 207, 229, 0.32), 0 0 0 1px rgba(156, 207, 229, 0.35);',
    '  animation: nuo-tb-glow-xfade-a 3.4s ease-in-out -0.6s infinite;',
    '}',
    '.fab-settings-morph::after {',
    '  box-shadow: 0 6px 18px rgba(120, 185, 210, 0.34), 0 0 0 1px rgba(156, 207, 229, 0.48);',
    '  animation: nuo-tb-glow-xfade-b 3.4s ease-in-out -0.6s infinite;',
    '}',
    ...
    '}',
    '.fab-settings-wrap:hover .fab-settings-morph::before,',
    '.fab-settings-wrap:hover .fab-settings-morph::after {',
    ...
    '  }',
    '}',
    '.fab-root.nuo-tb-off .fab-btn:not(:disabled)::before, .fab-root.nuo-tb-off .fab-btn:not(:disabled)::after,',
    '.fab-root .fab-dock:not(.fab-dock--open) .fab-btn:not(:disabled)::before,',
    '.fab-root .fab-dock:not(.fab-dock--open) .fab-btn:not(:disabled)::after,',
    '.fab-root.nuo-tb-off .fab-settings-morph::before, .fab-root.nuo-tb-off .fab-settings-morph::after,',
    '.fab-root .fab-dock:not(.fab-dock--open) .fab-settings-morph::before,',
    '.fab-root .fab-dock:not(.fab-dock--open) .fab-settings-morph::after {',
    ...
    '  opacity: 1; visibility: visible; pointer-events: auto;',
    '}',
    '.fab-root.nuo-tb-off .fab-prefs-gear {',
    ...
    '  background: linear-gradient(180deg, #f7fcfe 0%, #ffffff 42%, #e8f4fa 100%);',
    '  box-shadow: 0 24px 60px rgba(0,0,0,.22), 0 0 0 1px rgba(156,207,229,0.4);',
    '}',
    '.prefs-modal-close {',
    '  position: absolute; top: -13px; right: -13px;',
    '  width: 28px; height: 28px; border-radius: 50%;',
    '  background: rgba(220, 238, 248, 0.92);',
    '  backdrop-filter: blur(6px); -webkit-backdrop-filter: blur(6px);',
    '  color: #2a6f8f;',
    '  border: 1px solid rgba(156, 207, 229, 0.6);',
    '  box-shadow: 0 2px 10px rgba(42, 111, 143, 0.18);',
    ...
    '}',
    '.prefs-modal-close:hover { background: rgba(196, 228, 242, 0.95); transform: scale(1.1); }',
    '.prefs-modal-close:active { background: #c9e6f4; transform: scale(0.93); }',
    '@media (prefers-color-scheme: dark) {',
    '  .prefs-modal-frame {',
    '    background: linear-gradient(180deg, #07111d 0%, #0c1b2a 50%, #050e18 100%);',
    '    box-shadow: 0 24px 60px rgba(0,0,0,.55), 0 0 0 1px rgba(30,58,82,0.9);',
    '  }',
    '  .prefs-modal-close {',
    ...
    '  }',
    '  .prefs-modal-close:hover { background: rgba(10, 24, 40, 0.92); transform: scale(1.1); }',
    '  .prefs-modal-close:active { background: #07111d; transform: scale(0.93); }',
    '}',
  ].join('\n');
